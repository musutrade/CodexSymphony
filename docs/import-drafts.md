...
后续 M1 已加入[自然语言生成](draft-generation.md)、[覆盖映射与整组授权](group-review.md)、[依赖调度](group-queue.md)及[队列编辑](queue-editing.md)。validation_only 实际执行、自动合并与最终业务验收仍等待 M3；登录、公网部署与通知等待 M2。
