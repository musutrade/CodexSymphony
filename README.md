...
| 文档 | 效力 |
|---|---|
| [综合方案 V10.1](Personal_AI_Software_Factory_综合方案.md) | 当前实施契约；第 23 章为队列，第 24 章为验收索引 |
...
电脑/手机录入或导入 Agent 草稿 → 平台协助拆分大需求 → 一次评审整组 → 严格串行编码、PR、CI、有限修复、合并 → 子项与整体验收。普通澄清手机回答后继续，仅变化范围需重评。
