...
fn retain_evaluation(directory: &Path, evaluation: &Evaluation) -> Result<()> {
...
fn retain_invocation(directory: &Path, call: &Call) -> Result<()> {
...
fn check_required(plan: &Plan, call: &Call) -> Result<()> {
